...
public class ReligiousEventsFavActivity extends AppCompatActivity {String fileName="",filePath="",fileContent ="";
    ListView listView; ArrayList<String> arrayList =new ArrayList<>();
    ArrayAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_religious_events_fav);
        fileName = "wishes.txt";
        filePath = "MyWishes";
        try {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                AlertDialog.Builder a = new AlertDialog.Builder(ReligiousEventsFavActivity.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (!isExternalStorageAvailableForRW()) {
                            ...
                            if (!fileContent.equals("")) {
                                ...
                                Toast.makeText(ReligiousEventsFavActivity.this, "Wish Saved to SD Card", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ReligiousEventsFavActivity.this, "Text Field can not be Empty", Toast.LENGTH_SHORT).show();
                            }
                        }
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                new AlertDialog.Builder(ReligiousEventsFavActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Are You Sure?")
