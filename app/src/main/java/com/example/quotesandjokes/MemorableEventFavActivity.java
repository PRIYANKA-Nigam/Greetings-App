...
public class MemorableEventFavActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memorable_event_fav);
        fileName = "wishes.txt";
        filePath = "MyWishes";
        try {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                AlertDialog.Builder a = new AlertDialog.Builder(MemorableEventFavActivity.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (!isExternalStorageAvailableForRW()) {
                            ...
                            if (!fileContent.equals("")) {
                                ...
                                Toast.makeText(MemorableEventFavActivity.this, "Wish Saved to SD Card", Toast.LENGTH_SHORT).show();
                            } else {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.fav:
                SharedPreferences sh=getApplicationContext().getSharedPreferences("memorable",MODE_PRIVATE);
                HashSet<String> set=new HashSet<>(arrayList);
                sh.edit().putStringSet("event",set).apply();
