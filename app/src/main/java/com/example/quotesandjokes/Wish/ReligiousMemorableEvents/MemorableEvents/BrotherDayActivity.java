...
public class BrotherDayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brother_day);
        fileName = "wishes.txt";
        filePath = "MyWishes";
        arrayList=new ArrayList<>();
        listView=(ListView)findViewById(R.id.ll);
arrayList.add("Happy Brother Day to You");
arrayList.add("A brother’s love is always unconditional and free from all kinds of shackles. I am so proud to have a responsible brother like you.");
arrayList.add("Our relationship is full of sugar, spice and everything nice. Happy Brothers' Day");
arrayList.add("Happy Brother’s Day! To have a brother like you is a blessing!");
arrayList.add("The brotherly love I get from you is unique, and I believe I cannot get much from anyone else.");
arrayList.add("Warm wishes on the occasion to my brother. You are the best brother and I am really happy to have you as a part of my life.");
arrayList.add("Thank you for being the source of my strength and confidence. Happy Brother’s Day!");
arrayList.add("Happy Brother’s Day, dear brother! Thank you for always being the friend and guardian I need!");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                AlertDialog.Builder a = new AlertDialog.Builder(BrotherDayActivity.this);
                a.setMessage("do you want to Save or Share this Wish ?....").setCancelable(true)
                        .setPositiveButton("Share", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) { String flag="br";
